  ...
  return (
    <section className='max-w-6xl mx-auto'>
      <div className='flex flex-col  justify-center items-center pb-48'>
        <h3 className='text-xl sm:text-3xl font-bold text-white text-center pb-6'>
        ...
        <p className='text-center sm:text-left text-lg sm:text-2xl sm:tracking-wide font-base text-white pb-6'>
